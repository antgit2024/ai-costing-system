...
const menuItems: MenuProps['items'] = [
  ...
  },
  {
    ...
    children: [
      ...
      { key: '/costing/admin/cost-rate-hub', label: subItemLabel('💎 成本费率治理 Hub（v1.3）', '/costing/admin/cost-rate-hub') },
      { key: '/costing/admin/long-tail-cogs-rate', label: subItemLabel('💰 长尾成本策略（SKU 兜底）', '/costing/admin/long-tail-cogs-rate') },
